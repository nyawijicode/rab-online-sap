...
<body>
        ...
        <tr>
            ...
            <td>
                <ul style="margin:0; padding-left:18px;">
                    <li>Barang yang sudah diajukan / sudah ada, tidak boleh diajukan lagi (kecuali barang habis pakai &
                        rusak).</li>
                    <li>Setiap permintaan penggantian barang (kecuali barang habis pakai) harus disertai dengan barang
                        lama.</li>
                </ul>
            </td>
        </tr>
    ...
    @php
        ...
        $approvedStatuses = $pengajuan->statuses()
            ...
            ->sortBy(['display_priority', 'approved_at']) // others dulu, lalu komisaris, direktur, owner (ke kanan)
            ->values();
    @endphp
